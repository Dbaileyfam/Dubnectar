(function () {
  ...
  function animate() {
    ...
    blobs.forEach(function (blob, i) {
      ...
      var driftX = Math.sin(t * 0.22 + i * 1.2) * 65 + Math.sin(t * 0.12 + i * 0.7) * 35;
      var driftY = Math.cos(t * 0.18 + i * 0.8) * 50 + Math.cos(t * 0.11 + i * 1.3) * 28;
      var baseRot = parseFloat(blob.dataset.rotation || 0);
      var rot = baseRot + Math.sin(t * 0.1 + i) * 5;
